package org.tf2center.discordbot.commands;
...
@Component
public class NextLobbyCommand implements SlashCommand{
    ...
    public Mono<Void> handle(ChatInputInteractionEvent event) {
        ...
        EmbedCreateSpec lobbytxt = EmbedCreateSpec.builder()
                .color(Color.GREEN)
                .title("Lobby #1252026")
        ...
        return event.reply()
//                .withEmbeds(
//                        LobbyEmbedBuilder.of(TF2CWebSite.getPreview())
//                )
                .withEmbeds(lobbytxt)
                //.withComponents(ActionRow.of(previous,buttonLink,next))
                .withEphemeral(true)
                .withContent("LogicalDeleteParameter");
    }
